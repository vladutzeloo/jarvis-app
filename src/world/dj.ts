  ...
  root.innerHTML = `
    <div class="dj-dock-card">
      ...
      <div class="dj-dock-controls">
        <button type="button" data-dj-play title="Play / pause" aria-label="Play / pause">&#9654;</button>
        <button type="button" data-dj-next title="Next discovery" aria-label="Next discovery">&#9197;</button>
