  ...
  root.innerHTML = `
    <div class="librarian-dock-card">
      <div class="librarian-dock-header">
        ...
        <button class="librarian-dock-close" type="button" data-lib-close title="Close" aria-label="Close">×</button>
      </div>
      ...
      <form class="librarian-dock-form" data-lib-form autocomplete="off">
        ...
        <button type="submit" data-lib-ask title="Ask" aria-label="Ask">→</button>
      </form>
