  ...
  root.innerHTML = `
    <div class="librarian-dock-card">
      <div class="librarian-dock-header">
        ...
        <button class="librarian-dock-close" type="button" data-lib-close title="Close" aria-label="Close Librarian interface">×</button>
      </div>
      ...
      <form class="librarian-dock-form" data-lib-form autocomplete="off">
        <input type="text" data-lib-input placeholder="What does my vault say about…" spellcheck="false" aria-label="Librarian question input" />
